...
# テスト対象のモジュールをインポート
from github_automation_tool.adapters.github_utils import github_api_error_handler, _process_graphql_errors
...
class TestGithubApiErrorHandler(unittest.TestCase):
    ...
    def create_request_failed(
        ...
        """
        mock_response = self.create_mock_response(status_code, content, headers)
    ...
    def test_request_failed_401(self):
        ...
        self.assertEqual(context.exception.original_exception, request_failed_error)
    ...
    def test_graphql_error_permission_message(self):
        ...
        # エラーメッセージを検証
        self.assertIn("graphql permission message test context", str(context.exception))
    ...
    def test_unexpected_error(self):
        ...
        self.assertEqual(context.exception.original_exception, unexpected_error)
    ...
    def test_graphql_error_in_response_not_found(self):
        ...
        graphql_error = self.create_graphql_error_dict(error_type="NOT_FOUND", message="Resource not found")
        ...
        self.assertTrue(getattr(cm.exception, 'is_graphql_not_found', False), "is_graphql_not_found flag should be set")
    ...
    def test_graphql_error_in_response_forbidden(self):
        ...
        graphql_error = self.create_graphql_error_dict(error_type="FORBIDDEN", message="Permission denied")
    ...
    def test_graphql_error_in_response_generic(self):
        ...
        graphql_error = self.create_graphql_error_dict(error_type="INTERNAL_ERROR", message="Something went wrong")
        ...
        with self.assertRaises(GitHubClientError) as cm:
            test_function(self)
        self.assertNotIsInstance(cm.exception, (GitHubAuthenticationError, GitHubResourceNotFoundError))
    ...
    def test_process_graphql_errors_not_found(self):
        ...
        self.assertTrue(hasattr(cm.exception, 'is_graphql_not_found'), "is_graphql_not_found flag should exist")
    ...
    def test_response_with_attributes(self):
        ...
        mock_response = MagicMock()
        mock_response.errors = [{"type": "NOT_FOUND", "message": "Resource not found"}]
    ...
    def test_graphql_response_object_with_errors(self):
        ...
        if GraphQLResponse is None:
            self.skipTest("GraphQLResponse is not available in this environment")
        ...
        mock_response = MockGraphQLResponse([{"type": "FORBIDDEN", "message": "Permission denied"}])
