...
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY', 'django-insecure-^#ka#e-5+4m$$a_5qyro@*r8awt25_t=&h7g(8nknuo*orc5c9')
...
# Django REST Framework Settings を追加
REST_FRAMEWORK = {
    'DEFAULT_RENDERER_CLASSES': [
        'rest_framework.renderers.JSONRenderer',
        'rest_framework.renderers.BrowsableAPIRenderer',  # ブラウザからの確認用
    ],
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'app.authentication.CustomAPIKeyAuthentication',
    ],
    'DEFAULT_PERMISSION_CLASSES': [
        'app.permissions.HasValidAPIKey',
    ]
}
